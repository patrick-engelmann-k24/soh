...
resource "aws_sqs_queue_policy" "sns_sqs_sendmessage_policy_soh_core_sales_order_cancelled_dlq" {
  queue_url = aws_sqs_queue.soh_core_sales_order_cancelled_dlq.id
  policy    = data.aws_iam_policy_document.sns_sqs_sendmessage_policy_soh_core_sales_order_cancelled_dlq.json
}