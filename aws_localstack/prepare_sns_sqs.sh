...
TOPICS="soh-order-created soh-order-completed soh-order-cancelled soh-order-item-cancelled soh-invoice-address-changed soh-delivery-address-changed order-item-transmitted-to-logistics order-item-packing-started order-item-tracking-id-received order-item-delivered order-item-cancelled"
