...
public class SaveDropshipmentReturnInvoiceDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        SalesOrderReturn returnOrder = salesOrderReturnService.getByOrderNumber(orderNumber);
        if (returnOrder == null) {
            throw new NotFoundException(MessageFormat.format("Return order not found for the given order number {0} ", orderNumber));
        }
