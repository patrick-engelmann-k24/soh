...
@Component
public class RepublishReturnOrderHandler extends AbstractActionHandler {

    @Override
    protected Consumer<String> getAction() {
        return snsPublishService::publishMigrationReturnOrderCreatedEvent;
    }

    @Override
    public boolean supports(ActionType orderType) {
        return orderType == ActionType.REPUBLISH_RETURN_ORDER;
    }
}
