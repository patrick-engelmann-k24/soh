...
class ItemSplitServiceTest {
    ...
    void getProduct() {
        ...
        when(productService.getProductBySku("2270-13013")).thenReturn(productEnvelope.getProduct());
    ...
    protected void getProductFromJson(final String sku, final String json) {
        ...
        when(productService.getProductBySku(sku)).thenReturn(replacementProduct);
    }
