...
class TimedPollingServiceTest {
    ...
    @Test
    public void pollingEndsWithTrueAsSoonAsTheTestFunctionReturnsTrue() {
    ...
    @Test
    public void pollingEndsWithFalseAfterTheTimeoutIfTheTestFunctionAlwaysReturnsFalse() {
    ...
    @Test
    public void errorsThrownByTheTestFunctionDontAreCaught() {
    ...
    @Test
    public void pollWithDefaultTimingCallsPollWithDefaultValues() {
