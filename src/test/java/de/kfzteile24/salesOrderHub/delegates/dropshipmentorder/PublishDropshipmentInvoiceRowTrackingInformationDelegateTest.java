...
class PublishDropshipmentInvoiceRowTrackingInformationDelegateTest {
    ...
    @InjectMocks
    private PublishDropshipmentInvoiceRowTrackingInformationDelegate publishDropshipmentInvoiceRowTrackingInformationDelegate;
    ...
    void testPublishDropshipmentOrderRowTrackingInformationDelegate() throws Exception {
        ...
        publishDropshipmentInvoiceRowTrackingInformationDelegate.execute(delegateExecution);
