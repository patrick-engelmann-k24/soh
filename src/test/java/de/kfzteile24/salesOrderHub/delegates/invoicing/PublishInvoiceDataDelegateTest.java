...
public class PublishInvoiceDataDelegateTest {
    ...
    @InjectMocks
    private PublishInvoiceDataDelegate publishInvoiceDataDelegate;
    ...
    void testPublishInvoiceDataDelegate() {
        ...
        publishInvoiceDataDelegate.execute(delegateExecution);
